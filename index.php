...
<head>
	<meta charset="UTF-8">
	<title>JAMB Assistant &mdash; All you need to achieve your dreams</title>
	...
	<meta name="keywords" content="Admissions, JAMB, Nigeria, College, University, Courses, Schools, UTME, Chatbot, Education" />
	<meta name="author" content="JAMB Assistant" />
	...
	<meta property="og:site_name" content="JAMB Assistant"/>
	<meta property="og:description" content="An invaluable Assistant to help you or yours get admission and pursue your dreams!"/>
	<meta name="twitter:title" content="JAMB Assistant &mdash; All you need to achieve your dreams" />
...
<div id="page-wrap">
	...
	<div id="fh5co-hero-wrapper">
		<nav class="container navbar navbar-expand-lg main-navbar-nav navbar-light">
			<a class="navbar-brand" href="">Jamb Assistant</a>
		...
		<div class="container">
			...
			<div class="row fh5co-advantages-grid-columns wow animated fadeIn" data-wow-delay="0.36s">
				...
				<div class="col-sm-4">
					...
					<h1 class="grid-title">A.I and M.L</h1>
					<p class="grid-desc">Our chatbot is powered by the best Artificial Intelligence and Machine Learning Algorithms.</p>
				</div>

				<div class="col-sm-4">
					<img class="grid-image" src="img/icon-2.png" alt="Icon-2">
					<h1 class="grid-title">Offline mode</h1>
					<p class="grid-desc">What happens when you don't have data, or poor internet? We've thought about that, we've made the e-brochure available offline!</p>
				</div>

				<div class="col-sm-4">
					<img class="grid-image" src="img/icon-3.png" alt="Icon-3">
					<h1 class="grid-title">Design</h1>
					<p class="grid-desc">Inspired by Dieter's Maxim 'Less is More', we've achieved remarkable, minimalistic design.</p>
				</div>
	...
	<div class="fh5co-slider-outer wow fadeIn" data-wow-delay="0.36s">
		...
		<small>Genuis engineering meets stunning design</small>
		<div class="container fh5co-slider-inner">

			<div class="owl-carousel owl-theme">

				<div class="item"><img src="img/juliet/iphone-9.png" alt=""></div>
				<div class="item"><img src="img/juliet/iphone-3.png" alt=""></div>
				<div class="item"><img src="img/juliet/iphone-4.png" alt=""></div>
				<div class="item"><img src="img/juliet/iphone-6.png" alt=""></div>
				<div class="item"><img src="img/juliet/iphone-7.png" alt=""></div>
			...
			<div class="row fh5co-features-grid-columns">
				...
				<div class="col-sm-6 in-order-1 wow animated fadeInLeft" data-wow-delay="0.22s">
					<div class="col-sm-image-container">
						<img class="img-float-left" src="img/juliet/iphone-9.png" alt="smartphone-1">
						<span class="span-new">CHAT</span>
						<span class="span-free">Free</span>
					</div>
				</div>

				<div class="col-sm-6 in-order-2 sm-6-content wow animated fadeInRight" data-wow-delay="0.22s">
					<h1>JAMBO THE CHATBOT</h1>
					<p>The future is here! Jambo our chatbot, is your live assistant! ask him all about your carreer or other technical stuff and Jambo can also tell you jokes. Built on the best chatbot algorithms in the world, it is impressive.</p>
				...
				<div class="col-sm-6 in-order-3 sm-6-content wow animated fadeInLeft" data-wow-delay="0.22s">
					<h1>SEARCHABLE e-BROCHURE</h1>
					<p>It is offline! the most robust easy to use electronic brochure, it is the only alternative you have to a boring, complex pdf brochure. We've simplified it, an 8yr old can use without help, and it's offline! </p>
				...
				<div class="col-sm-6 in-order-4 wow animated fadeInRight" data-wow-delay="0.22s">
					<img class="img-float-right" src="img/juliet/iphone-3.png" alt="smartphone-2">
				</div>

				<div class="col-sm-6 in-order-5 wow animated fadeInLeft" data-wow-delay="0.22s">
					<div class="col-sm-image-container">
						<img class="img-float-left" src="img/juliet/iphone-10.png" alt="smartphone-3">
				...
				<div class="col-sm-6 in-order-6 sm-6-content wow animated fadeInRight" data-wow-delay="0.22s">
					<h1>FOOD FOR THE MIND</h1>
					<p>The mind is powerful, mindset is everything. Thus, provide invaluable pieces on hero's, events and challanges to push you or yours to glory</p>
		...
		<div class="container fh5co-reviews-inner">
			<div class="row justify-content-center">
				<div class="col-sm-5 wow fadeIn animated" data-wow-delay="0.25s">
					...
					<small class="testimonial-author">Sean Burrowes</small>
				...
				<div class="col-sm-5 testimonial-2 wow fadeIn animated" data-wow-delay="0.67s">
					<img class="float-left" src="img/quotes-1.jpg" alt="Quote 1">
					<p class="testimonial-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis similique quasi.</p>
					<small class="testimonial-author">Stella</small>
					<img class="float-right" src="img/quotes-2.jpg" alt="Quote 2">
				</div>
			</div>
			...
			<div class="container fh5co-bottom-inner">
				<div class="row">
					<div class="col-sm-6">
						...
						<p>Click any of the appropriate buttons below to download for iOS/iPadOS or Android now!</p>
	...
	<footer class="footer-outer">
		<div class="container footer-inner">
			...
			<p class="copyright">&copy; 2020 JAMB Assistant</p>
